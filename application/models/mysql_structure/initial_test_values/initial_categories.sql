...
('Dance is a type of art that generally involves movement of the body, often rhythmic and to music.'                                                       , 'анцът е вид изкуство, при който средства за създаване на художествен образ са движението и смяната на положението на човешкото тяло.');

insert into category
(pictureSrc           , nameId, descrId) values
